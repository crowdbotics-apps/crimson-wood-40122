"""
Django settings for crimson_wood_40122 project.
...
ROOT_URLCONF = 'crimson_wood_40122.urls'
...
WSGI_APPLICATION = 'crimson_wood_40122.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "crimson_wood_40122 API",
    "DESCRIPTION": "API documentation for crimson_wood_40122 App",
    "VERSION": "v1",
}
